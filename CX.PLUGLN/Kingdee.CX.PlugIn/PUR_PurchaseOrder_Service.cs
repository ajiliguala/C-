...
namespace Kingdee.CX.PlugIn
{
	...
	[Description("采购订单反审核删除SRM单据")]
	[HotUpdate]
	public class PUR_PurchaseOrder_Service : AbstractOperationServicePlugIn
	{
		// Token: 0x0600007E RID: 126 RVA: 0x000058D0 File Offset: 0x00003AD0
		...
		// Token: 0x0600007F RID: 127 RVA: 0x00005900 File Offset: 0x00003B00
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text4 = Helper.BuildApiUrl(text4, PUR_PurchaseOrder_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										text3 = string.Format("update t_PUR_POOrder set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x06000080 RID: 128 RVA: 0x00005E38 File Offset: 0x00004038
