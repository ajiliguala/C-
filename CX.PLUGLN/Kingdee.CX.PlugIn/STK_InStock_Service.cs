...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x06000093 RID: 147 RVA: 0x00007900 File Offset: 0x00005B00
		...
		// Token: 0x06000094 RID: 148 RVA: 0x00007A6C File Offset: 0x00005C6C
		public override void EndOperationTransaction(EndOperationTransactionArgs e)
		{
			...
			if (flag)
			{
				foreach (DynamicObject dynamicObject in e.DataEntitys)
				{
					...
					bool flag2 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject2);
					if (flag2)
					{
						...
						if (flag4)
						{
							bool flag5 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject3);
							if (flag5)
							{
								...
								if (flag6)
								{
									...
									foreach (DynamicObject dynamicObject5 in dynamicObjectCollection)
									{
										...
										bool flag7 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject6);
										if (flag7)
										{
										...
										bool flag8 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject7);
										if (flag8)
										{
										...
										bool flag10 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject4);
										if (flag10)
										{
										...
										bool flag11 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject8);
										if (flag11)
										{
										...
										bool flag12 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject9);
										if (flag12)
										{
										...
										bool flag13 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject10);
										if (flag13)
										{
										...
										string text2 = string.Format("select a.fid,a.FBILLNO,d.FBILLNO CGDDH,d.FDATE CGRQ,FDELIVERYDATE from t_STK_InStock a \r\n                                    join T_STK_INSTOCKENTRY b on a.FID=b.FID\r\n                                    join t_PUR_POOrderEntry c on c.FENTRYID=FPOORDERENTRYID\r\n                                    join t_PUR_POOrder d on c.FID=d.FID\r\n                                    join T_PUR_POORDERENTRY_D e on e.FENTRYID=c.FENTRYID\r\n                                    where FPOORDERENTRYID={0}", Helper.ToLong(dynamicObject5["POORDERENTRYID"]));
										DynamicObject dynamicObject11 = DBUtils.ExecuteDynamicObject(base.Context, text2, null, null, CommandType.Text, Array.Empty<SqlParam>()).FirstOrDefault<DynamicObject>();
										bool flag14 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject11);
										if (flag14)
										{
									...
									string text3 = JsonConvert.SerializeObject(list2.ToArray());
									Helper.WriteLog("STK_InStock-TPM", text3);
									string value5 = Utils.HttpPostApi(this.url, text3);
									...
									string text4 = string.Format("update t_STK_InStock set F_YTSTPM = '1' where FBILLNO= '{0}'", text);
									DBServiceHelper.Execute(base.Context, text4);
								}
							}
						}
					}
			...
			if (flag16)
			{
				...
				{
					string text5 = Helper.ToStr(dynamicObject12["BillNo"], 0);
					string a3 = Helper.ToBool(dynamicObject12["F_YTSTPM"]);
					bool flag17 = a3 == "true";
					if (flag17)
					{
						string requestJson = "http://10.11.111.63:8800/api/Tpm/Machine/DeApproval?instock_code=" + text5;
						...
						string text6 = string.Format("update t_STK_InStock set F_YTSTPM = '0' where FBILLNO= '{0}'", text5);
						DBServiceHelper.Execute(base.Context, text6);
					}
				}
			}
		}
