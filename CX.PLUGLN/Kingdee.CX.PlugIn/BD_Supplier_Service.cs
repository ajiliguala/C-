...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x060000CA RID: 202 RVA: 0x0000A140 File Offset: 0x00008340
		...
		// Token: 0x060000CB RID: 203 RVA: 0x0000A1BC File Offset: 0x000083BC
				...
				foreach (DynamicObject dynamicObject in e.DataEntitys)
				{
					...
					if (flag2)
					{
						...
						if (flag3)
						{
							...
							string text4 = string.Format("update t_BD_Supplier set F_YTSTPM = '1' where FNUMBER= '{0}'", text);
