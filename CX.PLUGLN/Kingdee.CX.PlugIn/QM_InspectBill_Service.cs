...
namespace Kingdee.CX.PlugIn
{
	...
	[Description("检验单反审核删除SRM单据")]
	[HotUpdate]
	public class QM_InspectBill_Service : AbstractOperationServicePlugIn
	{
		// Token: 0x0600008E RID: 142 RVA: 0x000072EE File Offset: 0x000054EE
		public override void OnPreparePropertys(PreparePropertysEventArgs e)
		{
			base.OnPreparePropertys(e);
			e.FieldKeys.Add("FInspectOrgId");
			e.FieldKeys.Add("F_SRMIDENT");
		}

		// Token: 0x0600008F RID: 143 RVA: 0x0000731C File Offset: 0x0000551C
		public override void BeginOperationTransaction(BeginOperationTransactionArgs e)
		{
			...
			if (flag)
			{
				...
				foreach (DynamicObject dynamicObject in e.DataEntitys)
				{
					...
					if (flag2)
					{
						DynamicObject dynamicObject2 = dynamicObject["InspectOrgId"] as DynamicObject;
						...
						if (flag3)
						{
							try
							{
								...
								DynamicObject dynamicObject3 = DBUtils.ExecuteDynamicObject(base.Context, text3, null, null, CommandType.Text, Array.Empty<SqlParam>()).FirstOrDefault<DynamicObject>();
								bool flag4 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject3);
								if (flag4)
								{
									string text4 = Helper.ToStr(dynamicObject3["F_STYZ_JKDZ"], 0);
									text4 = Helper.BuildApiUrl(text4, QM_InspectBill_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										text3 = string.Format("update T_QM_INSPECTBILL set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x06000090 RID: 144 RVA: 0x00007854 File Offset: 0x00005A54
