...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x06000076 RID: 118 RVA: 0x00004DBC File Offset: 0x00002FBC
		...
		// Token: 0x06000077 RID: 119 RVA: 0x00004E28 File Offset: 0x00003028
		public override void EndOperationTransaction(EndOperationTransactionArgs e)
		{
				...
				foreach (DynamicObject dynamicObject in e.DataEntitys)
				{
					...
					if (flag2)
					{
						...
						foreach (DynamicObject dynamicObject2 in dynamicObjectCollection)
						{
							...
							string text2 = string.Format("select FID from t_PUR_POOrder where FBILLNO='{0}'", arg);
							DynamicObject dynamicObject3 = DBUtils.ExecuteDynamicObject(base.Context, text2, null, null, CommandType.Text, Array.Empty<SqlParam>()).FirstOrDefault<DynamicObject>();
							bool flag3 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject3) && num > 0.0 && num2 > 0;
							if (flag3)
							{
			...
			if (flag5)
			{
				...
				{
					string text3 = Helper.ToStr(dynamicObject4["BillNo"], 0);
					...
					if (flag6)
					{
						...
						foreach (DynamicObject dynamicObject5 in dynamicObjectCollection2)
						{
							...
							string text4 = string.Format("select FID from t_PUR_POOrder where FBILLNO='{0}'", arg2);
							DynamicObject dynamicObject6 = DBUtils.ExecuteDynamicObject(base.Context, text4, null, null, CommandType.Text, Array.Empty<SqlParam>()).FirstOrDefault<DynamicObject>();
							bool flag7 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject6) && num3 > 0.0 && num4 > 0;
							if (flag7)
							{
