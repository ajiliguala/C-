...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x060000BB RID: 187 RVA: 0x00009310 File Offset: 0x00007510
		...
		// Token: 0x060000BC RID: 188 RVA: 0x00009658 File Offset: 0x00007858
		public override ReportHeader GetReportHeaders(IRptParams filter)
		{
			ReportHeader reportHeader = new ReportHeader();
			reportHeader.AddChild("Fprdnumber", new LocaleValue("成品料号"), 167, true);
			reportHeader.AddChild("Fprdxps", new LocaleValue("成品大张对应小片数"), 106, true);
			reportHeader.AddChild("Fbooknumber", new LocaleValue("加工贸易账册编号"), 167, true);
			reportHeader.AddChild("Fmtrlnumber", new LocaleValue("料件料号"), 167, true);
			reportHeader.AddChild("Fmtrlxps", new LocaleValue("料件大张对应小片数"), 106, true);
			reportHeader.AddChild("Fmtrlname", new LocaleValue("料件名称"), 167, true);
			reportHeader.AddChild("Fmodel", new LocaleValue("料件规格"), 167, true);
			reportHeader.AddChild("FmtrlJKqty", new LocaleValue("料件进口数量"), 106, true);
			reportHeader.AddChild("FmtrlJKqty_xps", new LocaleValue("料件进口数量(小片)"), 106, true);
			reportHeader.AddChild("FOEMInstockqty", new LocaleValue("料件入库数量"), 106, true);
			reportHeader.AddChild("FOEMInstockqty_xps", new LocaleValue("料件入库数量(小片)"), 106, true);
			reportHeader.AddChild("FmtrlJZqty", new LocaleValue("余料结转数量"), 106, true);
			reportHeader.AddChild("FmtrlJZqty_xps", new LocaleValue("余料结转数量(小片)"), 106, true);
			reportHeader.AddChild("FmtrlFCqty", new LocaleValue("料件复出数量"), 106, true);
			reportHeader.AddChild("FmtrlFCqty_xps", new LocaleValue("料件复出数量(小片)"), 106, true);
			reportHeader.AddChild("FmtrlNXqty", new LocaleValue("料件内销数量"), 106, true);
			reportHeader.AddChild("FmtrlNXqty_xps", new LocaleValue("料件内销数量(小片)"), 106, true);
			reportHeader.AddChild("FprdCKqty", new LocaleValue("成品出口数量"), 106, true);
			reportHeader.AddChild("FprdCKqty_xps", new LocaleValue("成品出口数量(小片)"), 106, true);
			reportHeader.AddChild("FPrdSalOStockqty", new LocaleValue("成品出库数量"), 106, true);
			reportHeader.AddChild("FPrdSalOStockqty_xps", new LocaleValue("成品出库数量(小片)"), 106, true);
			reportHeader.AddChild("FmtrlInvqty", new LocaleValue("料件库存"), 106, true);
			reportHeader.AddChild("FmtrlInvqty_xps", new LocaleValue("料件库存(小片)"), 106, true);
			reportHeader.AddChild("FprdInventoryqty", new LocaleValue("成品库存"), 106, true);
			reportHeader.AddChild("FprdInventoryqty_xps", new LocaleValue("成品库存(小片)"), 106, true);
			reportHeader.AddChild("FBGCY", new LocaleValue("报关差异"), 106, true);
			reportHeader.AddChild("FBGCY_xps", new LocaleValue("报关差异(小片)"), 106, true);
			reportHeader.AddChild("FRemQty", new LocaleValue("理论结余库存"), 106, true);
			reportHeader.AddChild("FRemQty_xps", new LocaleValue("理论结余库存(小片)"), 106, true);
			return reportHeader;
		}

		// Token: 0x060000BD RID: 189 RVA: 0x00009958 File Offset: 0x00007B58
		...
		// Token: 0x060000BE RID: 190 RVA: 0x000099C8 File Offset: 0x00007BC8
