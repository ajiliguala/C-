...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x0600006E RID: 110 RVA: 0x000046B8 File Offset: 0x000028B8
		...
		// Token: 0x0600006F RID: 111 RVA: 0x000046E8 File Offset: 0x000028E8
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text4 = Helper.BuildApiUrl(text4, AP_PAYBILL_UnAudit_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										text3 = string.Format("update T_AP_PAYBILL set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x06000070 RID: 112 RVA: 0x00004C20 File Offset: 0x00002E20
