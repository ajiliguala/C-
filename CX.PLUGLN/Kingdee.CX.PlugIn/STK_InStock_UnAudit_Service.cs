...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x06000099 RID: 153 RVA: 0x00008728 File Offset: 0x00006928
		...
		// Token: 0x0600009A RID: 154 RVA: 0x00008758 File Offset: 0x00006958
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text4 = Helper.BuildApiUrl(text4, STK_InStock_UnAudit_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										text3 = string.Format("update t_STK_InStock set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x0600009B RID: 155 RVA: 0x00008C90 File Offset: 0x00006E90
