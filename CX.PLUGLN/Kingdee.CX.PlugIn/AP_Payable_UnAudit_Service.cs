...
namespace Kingdee.CX.PlugIn
{
	...
	public class AP_Payable_UnAudit_Service : AbstractOperationServicePlugIn
	{
				...
				foreach (DynamicObject dynamicObject in e.DataEntitys)
				{
					...
					else
					{
						...
						if (flag3)
						{
							...
							bool flag4 = !ObjectUtils.IsNullOrEmptyOrWhiteSpace(dynamicObject2);
							if (flag4)
							{
								try
								{
									...
									if (flag5)
									{
										...
										text4 = Helper.BuildApiUrl(text4, AP_Payable_UnAudit_Service.API_DELETE_METHOD);
										...
										if (flag6)
										{
											text3 = string.Format("update T_AP_PAYABLE set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x06000068 RID: 104 RVA: 0x0000451C File Offset: 0x0000271C
