...
namespace Kingdee.CX.PlugIn
{
	...
	[Description("收料通知单反审核删除SRM单据")]
	[HotUpdate]
	public class PUR_ReceiveBill_Service : AbstractOperationServicePlugIn
	{
		// Token: 0x06000083 RID: 131 RVA: 0x00005EE4 File Offset: 0x000040E4
		public override void OnPreparePropertys(PreparePropertysEventArgs e)
		{
			base.OnPreparePropertys(e);
			e.FieldKeys.Add("FPurOrgId");
			e.FieldKeys.Add("F_SRMIDENT");
		}

		// Token: 0x06000084 RID: 132 RVA: 0x00005F14 File Offset: 0x00004114
		public override void BeginOperationTransaction(BeginOperationTransactionArgs e)
		{
			...
			if (flag)
			{
				...
				foreach (DynamicObject dynamicObject in e.DataEntitys)
				{
					...
					if (flag2)
					{
						DynamicObject dynamicObject2 = dynamicObject["PurOrgId"] as DynamicObject;
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text4 = Helper.BuildApiUrl(text4, PUR_ReceiveBill_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										text3 = string.Format("update T_PUR_Receive set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x06000085 RID: 133 RVA: 0x0000644C File Offset: 0x0000464C
