...
namespace Kingdee.CX.PlugIn
{
	...
	{
		// Token: 0x060000C5 RID: 197 RVA: 0x00009D50 File Offset: 0x00007F50
		...
		// Token: 0x060000C6 RID: 198 RVA: 0x00009E58 File Offset: 0x00008058
		public override ReportHeader GetReportHeaders(IRptParams filter)
		{
			ReportHeader reportHeader = new ReportHeader();
			reportHeader.AddChild("FORGID", new LocaleValue("组织(全)"), 167, true);
			reportHeader.AddChild("FSUBREQBILLNO", new LocaleValue("委外订单编号(全)"), 167, true);
			reportHeader.AddChild("FSUBREQENTRYSEQ", new LocaleValue("委外订单行号(全)"), 56, true);
			reportHeader.AddChild("FORGID_a", new LocaleValue("组织"), 167, true);
			reportHeader.AddChild("FSUBREQBILLNO_a", new LocaleValue("委外订单编号"), 167, true);
			reportHeader.AddChild("FSUBREQENTRYSEQ_a", new LocaleValue("委外订单行号"), 56, true);
			reportHeader.AddChild("FSUBPRDNUMBER", new LocaleValue("成品物料代码"), 167, true);
			reportHeader.AddChild("FPRDNAME", new LocaleValue("成品物料名称"), 167, true);
			reportHeader.AddChild("FPRDMODEL", new LocaleValue("成品规格型号"), 167, true);
			reportHeader.AddChild("FPRDUNIT", new LocaleValue("成品单位"), 167, true);
			reportHeader.AddChild("FInstockQty", new LocaleValue("成品入库数量"), 106, true);
			reportHeader.AddChild("FPrdCLCost", new LocaleValue("材料成本(本位币)"), 106, true);
			reportHeader.AddChild("FPrdJGCost", new LocaleValue("加工费(本位币)"), 106, true);
			reportHeader.AddChild("FPrdSUMCost", new LocaleValue("总成本(本位币)"), 106, true);
			reportHeader.AddChild("FMTRLNUMBER", new LocaleValue("料件物料代码"), 167, true);
			reportHeader.AddChild("FMTRLNAME", new LocaleValue("料件物料名称"), 167, true);
			reportHeader.AddChild("FMTRLMODEL", new LocaleValue("料件规格型号"), 167, true);
			reportHeader.AddChild("FMTRLUNIT", new LocaleValue("料件单位"), 167, true);
			reportHeader.AddChild("FPickMtrlQty", new LocaleValue("料件领料数量"), 106, true);
			reportHeader.AddChild("FMtrlAmount", new LocaleValue("委外总成本"), 106, true);
			return reportHeader;
		}

		// Token: 0x060000C7 RID: 199 RVA: 0x0000A08C File Offset: 0x0000828C
