...
namespace Kingdee.CX.PlugIn
{
	...
	[Description("采购退料单反审核删除SRM单据")]
	[HotUpdate]
	public class PUR_MRB_UnAudit_Service : AbstractOperationServicePlugIn
	{
		...
		// Token: 0x0600007A RID: 122 RVA: 0x000052EC File Offset: 0x000034EC
						...
						if (flag3)
						{
							try
							{
								...
								if (flag4)
								{
									...
									text4 = Helper.BuildApiUrl(text4, PUR_MRB_UnAudit_Service.API_DELETE_METHOD);
									...
									if (flag5)
									{
										text3 = string.Format("update t_PUR_MRB set F_SRMIDENT = '0' where FBILLNO= '{0}'", text);
		...
		// Token: 0x0600007B RID: 123 RVA: 0x00005824 File Offset: 0x00003A24
